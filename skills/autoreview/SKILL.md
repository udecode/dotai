---
name: autoreview
description: Review an explicit code candidate or an actual PR closeout with actionable findings, bounded correction rounds and source-backed adjudication.
metadata:
