...
Create a strategic, implementation-ready PRD through interactive Q&A. Focus on problem statements, architecture requirements, and success metrics. Ensure clarity through targeted questions that uncover the "why" before the "what".
...
Ask 4-6 targeted questions to uncover strategic context. **Start with problem/value, then move to functionality.**

### Problem & Value Questions (ALWAYS START HERE)

- **Challenge**: "What specific problem or pain point does this solve for users?"
- **Context**: "Why is this needed now? What's the current situation?"
- **Impact**: "What happens if we don't build this? What value will it deliver?"
- **User Value**: "How will this measurably improve the user experience?"

### Functionality Questions

- **Target User**: "Who is the primary user? Are there different user types?"
- **Core Actions**: "What are the 3-5 key actions users need to perform?"
- **User Stories**: "Can you provide 2-3 user stories? (As a [user], I want to [action] so that [benefit])"
- **User Flow**: "Describe the main user journey from start to finish"

### Requirements Questions

- **Mandatory Requirements**: "What are the must-have technical requirements?"
- **Performance Targets**: "Are there specific performance requirements? (response time, throughput, etc.)"
- **Success Metrics**: "How will we measure if this feature is successful?"
- **Quality Gates**: "What are the non-negotiable quality criteria?"

### Scope & Integration Questions

- **Scope/Boundaries**: "What should this feature NOT do (non-goals)?"
- **Technical Integration**: "What existing systems/components should this integrate with?"
...
- **Development Phases**: "What's the MVP vs future enhancements?"
- **Design/UI**: "Are there existing design patterns to follow?"
- **Risks**: "What potential technical challenges or edge cases should we consider?"
